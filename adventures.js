...
var adventures = [
    new adventure("Adventure 1: Caverns and Kobolds",
    ...
    new adventure("Adventure 2 : After Andrews",
    ...
    new adventure("Adventure 3: Squirrel Shenanigans",
...
loadXMLDoc("/Resources/adventures.xml");
